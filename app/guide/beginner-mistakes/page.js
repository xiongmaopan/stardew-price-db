      ...
      <main className="mx-auto max-w-5xl px-4 py-12">
        ...
        <section className="mb-8 rounded-xl border border-blue-200 bg-blue-50 p-6">
          ...
          <p className="leading-7 text-blue-950">
            This is original StardewPriceDB guide content with a practical player-first tone. The advice is not a generic
            beginner list: it focuses on mistakes that permanently waste rare items,
