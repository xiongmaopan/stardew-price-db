      ...
      <main className="mx-auto max-w-5xl px-4 py-12">
        ...
        <section className="mb-8 rounded-xl border border-blue-200 bg-blue-50 p-6">
          ...
          <p className="leading-7 text-blue-950">
            This is original StardewPriceDB guide content. The route is built from hands-on Stardew planning notes
            into a practical player-first guide, while timing, rewards, and profession
